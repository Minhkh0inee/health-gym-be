  ...
  async createUserHealth(req, res) {
    try {
      ...
      successResponse(
        res,
        newUserHealth,
        `Health of user ${userId} created successfully`,
        201
      );
    } catch (err) {
  ...
  async getUserHealth(req, res) {
    try {
      ...
      successResponse(
        res,
        userHealth,
        `Health of user ${userId} retrivied successfully`,
        200
      );
    } catch (err) {
      errorResponse(res, err, err.message, 400);
  ...
  async getUserHealthDetail(req, res) {
    try {
      ...
      successResponse(
        res,
        userHealth,
        `Health with ${id} of user ${userId} retrivied successfully`,
        200
      );
    } catch (err) {
      errorResponse(res, err, err.message, 400);
  ...
  async updateHealthDetail(req, res) {
    try {
      ...
      successResponse(
        res,
        userHealth,
        `Health with ${id} of user ${userId} updated successfully`,
        200
      );
    } catch (err) {
      errorResponse(res, err, err.message, 400);
  ...
  async deleteHealth(req, res) {
    try {
      ...
      successResponse(
        res,
        userHealth,
        `Health with ${id} of user ${userId} deleted successfully`,
        200
      );
    } catch (err) {
      errorResponse(res, err, err.message, 400);
